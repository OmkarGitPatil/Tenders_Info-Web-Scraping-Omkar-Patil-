...
class Scrape():
    ...
    def get_csv(self):
        ...
        df_dict={'URL of Tender':self.project_links[0:10],'Project ID':self.Bidding_No,'Project Name':self.Project_Name,
        ...
        df.to_csv(r'C:\Users\Omkar\Desktop\World Bank Projects\Web Scraper\CSV file\China Bidding Info.csv')
