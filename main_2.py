...
class Scrape():
    ...
    def attributes(self):
        ...
        self.k=[]
        self.l=[]
        for i in self.project_links[20:30]:
    ...
    def get_csv(self):
        ...
        df_dict={'URL of Tender':self.project_links[20:30],'Project ID':self.Bidding_No,'Project Name':self.Project_Name,
        ...
        df.to_csv(r'C:\Users\Omkar\Desktop\World Bank Projects\Web Scraper\CSV file\China Bidding Info 2.csv')
